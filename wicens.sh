...
F_default_update_create() {
	{
		...
		F_printfstr "cron_check_freq=9   # days between cron checks  default:9 (days)"
		F_printfstr "cron_string=\"0 9 */\${cron_check_freq} * * $script_name_full cron\""
		F_printfstr "cron_option=0   # run cron  default:1 (on)"
		F_printfstr "script_log=0   # independent wicens logging  default:1 (on)"
...
F_opt_about() {
	...
	{   # start of | more
		...
		F_printfstr "1/${cron_check_freq}dins) in $update_period second intervals.                " ; F_printfstr ''
